...
-- Date        : Wed Mar 26 17:29:11 2025
-- Host        : Caribou-VM-HEPHY running 64-bit Rocky Linux release 8.9 (Green Obsidian)
-- Command     : write_vhdl -force -mode funcsim
--               /home/pct/Caribou/MPW4/LED_CH/LED_CH.gen/sources_1/bd/LED_CH/ip/LED_CH_led_blink_patterns_0_0/LED_CH_led_blink_patterns_0_0_sim_netlist.vhdl
-- Design      : LED_CH_led_blink_patterns_0_0
...
entity LED_CH_led_blink_patterns_0_0_led_pattern is
  port (
  ...
  attribute ORIG_REF_NAME of LED_CH_led_blink_patterns_0_0_led_pattern : entity is "led_pattern";
end LED_CH_led_blink_patterns_0_0_led_pattern;

architecture STRUCTURE of LED_CH_led_blink_patterns_0_0_led_pattern is
  ...
  signal \NLW_counter_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 4 );
  signal \NLW_counter_reg[16]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 5 );
  ...
  attribute SOFT_HLUTNM of \led_reg[7]_i_3\ : label is "soft_lutpair3";
begin
...
\counter_reg[16]_i_1\: unisim.vcomponents.CARRY8
     port map (
      ...
      CI_TOP => '0',
      CO(7 downto 4) => \NLW_counter_reg[16]_i_1_CO_UNCONNECTED\(7 downto 4),
      CO(3) => \counter_reg[16]_i_1_n_4\,
      CO(2) => \counter_reg[16]_i_1_n_5\,
      CO(1) => \counter_reg[16]_i_1_n_6\,
      CO(0) => \counter_reg[16]_i_1_n_7\,
      DI(7 downto 0) => B"00000000",
      O(7 downto 5) => \NLW_counter_reg[16]_i_1_O_UNCONNECTED\(7 downto 5),
      ...
      S(7 downto 5) => B"000",
      S(4 downto 0) => counter_reg(20 downto 16)
    );
...
\led_reg[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000080"
    )
        port map (
      I0 => \led_reg[7]_i_4_n_0\,
      I1 => \led_reg[7]_i_5_n_0\,
      I2 => \led_reg[7]_i_6_n_0\,
      I3 => counter_reg(2),
      I4 => counter_reg(1),
      I5 => counter_reg(0),
      O => led_reg
    );
\led_reg[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"74"
    )
        port map (
...
\led_reg[7]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LED_CH_led_blink_patterns_0_0_led_top is
  port (
    led_o : out STD_LOGIC_VECTOR ( 7 downto 0 );
    pattern_sel : in STD_LOGIC;
    clk_i : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of LED_CH_led_blink_patterns_0_0_led_top : entity is "led_top";
end LED_CH_led_blink_patterns_0_0_led_top;

architecture STRUCTURE of LED_CH_led_blink_patterns_0_0_led_top is
begin
U_LED: entity work.LED_CH_led_blink_patterns_0_0_led_pattern
     port map (
      arstn_i => arstn_i,
      clk_i => clk_i,
      led_o(7 downto 0) => led_o(7 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity LED_CH_led_blink_patterns_0_0 is
  port (
    clk_i : in STD_LOGIC;
    arstn_i : in STD_LOGIC;
    pattern_sel : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of LED_CH_led_blink_patterns_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of LED_CH_led_blink_patterns_0_0 : entity is "LED_CH_led_blink_patterns_0_0,led_top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of LED_CH_led_blink_patterns_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of LED_CH_led_blink_patterns_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of LED_CH_led_blink_patterns_0_0 : entity is "led_top,Vivado 2023.2";
end LED_CH_led_blink_patterns_0_0;

architecture STRUCTURE of LED_CH_led_blink_patterns_0_0 is
begin
U0: entity work.LED_CH_led_blink_patterns_0_0_led_top
     port map (
      arstn_i => arstn_i,
      clk_i => clk_i,
      led_o(7 downto 0) => led_o(7 downto 0),
