...
HD_PWD='/home/silicon/Desktop/MPW4/LED_CH/LED_CH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_CH_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_CH_wrapper.tcl -notrace
