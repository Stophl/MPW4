...
HD_PWD='/home/silicon/Desktop/MPW4/LED_CH/LED_CH.runs/LED_CH_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_CH_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_CH_auto_ds_0.tcl
