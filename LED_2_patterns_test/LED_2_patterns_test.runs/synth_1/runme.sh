...
HD_PWD='/home/pct/Caribou/MPW4/LED_2_patterns_test/LED_2_patterns_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_2_patterns_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_2_patterns_wrapper.tcl
