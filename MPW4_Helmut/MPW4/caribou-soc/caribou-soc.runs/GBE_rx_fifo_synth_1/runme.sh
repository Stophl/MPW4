...
HD_PWD='/home/pct/Caribou/MPW4_Helmut/MPW4/caribou-soc/caribou-soc.runs/GBE_rx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GBE_rx_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GBE_rx_fifo.tcl
