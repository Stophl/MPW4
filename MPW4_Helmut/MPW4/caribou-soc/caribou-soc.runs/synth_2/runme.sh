...
HD_PWD='/home/pct/Caribou/MPW4_Helmut/MPW4/caribou-soc/caribou-soc.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log caribou_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source caribou_top_wrapper.tcl
