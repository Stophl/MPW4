...
HD_PWD='/home/pct/Caribou/MPW4_Helmut/MPW4/caribou-soc/caribou-soc.runs/transmit_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transmit_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transmit_fifo.tcl
