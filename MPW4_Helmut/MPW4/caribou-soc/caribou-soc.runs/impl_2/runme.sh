...
HD_PWD='/home/pct/Caribou/MPW4_Helmut/MPW4/caribou-soc/caribou-soc.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log caribou_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source caribou_top_wrapper.tcl -notrace
