...
#LVDS-CML buffers
set tlvdstocml_min 0.13
set tlvdstocml_max 0.28
set tlvdstocml_mean [expr [expr $tlvdstocml_min + $tlvdstocml_max] / 2 ]

#CML-LVDS buffers
set tcmltolvds_min 0.13
set tcmltolvds_max 0.42

#Clk
##to CLICpix2
set tclk_si5345toclicpix_car 0.898
set tclk_si5345toclicpix_chipboard [ expr 0.144 + 0.1 ]
set tclk_si5345toclicpix_mean [ expr $tclk_si5345toclicpix_car + $tclk_si5345toclicpix_chipboard + $tlvdstocml_mean ]
##to FPGA
set tclk_si5345tofpga_car [expr 0.084 + 0.023]
set tclk_si5345tofpga_zc706 0.749

#SS
set tss_zc706 0.712
set tss_car 0.982
set tss_chipboard_min [expr 0.194 + 0.088 + $tlvdstocml_min]
set tss_chipboard_max [expr 0.194 + 0.088 + $tlvdstocml_max]

#MOSI
set tmosi_zc706 0.712
set tmosi_car 0.990
set tmosi_chipboard_min [expr 0.192 + 0.078 + $tlvdstocml_min]
set tmosi_chipboard_max [expr 0.192 + 0.078 + $tlvdstocml_max]

#MISO
set tmiso_chipboard_min [expr 0.114 + 0.018 + 0.076 + $tcmltolvds_min]
set tmiso_chipboard_max [expr 0.114 + 0.018 + 0.076 + $tcmltolvds_max]
set tmiso_car 1.04
set tmiso_zc706 0.703
